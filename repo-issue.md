...
- [x] Create generate_classification_stats.py script
- [x] Store stats in stat/class/YYYY/MM/DD.json
- [x] Integrated into generate_summary.py workflow
- [x] Test with today's data
